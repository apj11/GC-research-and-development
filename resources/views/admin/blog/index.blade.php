...
@section('content')
    ...
    <div class="content-body content-body-calendar" style="margin-top: -50px;">
        <div class="d-md-flex justify-content-between">
            <h4 class="content-title mg-t-10">Welcome to blog</h4>
            <a href="{{route('blog.create')}}" class="btn btn-sm btn-primary"> Add new Blog</a>
            ...
            <table id="example1" class="table">
                ...
                @foreach($blog as $key =>$blog )
                    <tr id="blog{{$blog->id}}">
                        ...
                        <td ><img src="{{asset(''.$blog->image)}}" height="100px" width="100px"></td>
                        <td >{!! $blog->name !!} </td>
                        <td >{{$blog->date}} </td>
                        {{--                        <td >{{$blog->author}} </td>--}}
                        {{--                        <td >{!! $blog->category !!} </td>--}}
                        ...
                        <td class="d-md-flex">
                            ...
                            <div class="mg-r-20" title="Edit"><a href="{{route('blog.edit',$blog->id)}}"><i class="far fa-edit text-warning"></i></a></div>
                             <div class="mg-r-20" title="Delete"><a href="{{route('blog.destroy',$blog->id)}}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="icon ion-trash-b text-danger"></i></a></div>
                            <!-- <a href="javascript:void(0)" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger remove_button" url="{{route('blog.destroy',$blog->id)}}"><i class="fa fa-times"></i></a> -->
                        </td>
                    </tr>
                    {{--                <tr>--}}
                    {{--                    <td>2076/12/15</td>--}}
