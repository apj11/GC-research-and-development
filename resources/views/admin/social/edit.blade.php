        ...
        <div class="col-lg-12">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Update</strong> Social link</h2>
                </div>
                <!-- END General Data Title -->

                <!-- General Data Content -->
                <form action="{{route('social.update',[$social->id])}}" method="post" class="form-horizontal form-bordered"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="facebook" name="facebook" class="form-control {{ $errors->has('facebook') ? 'has-error' : '' }}"  value="{{ old('facebook', isset($social) ? $social->facebook : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="twitter" name="twitter" class="form-control {{ $errors->has('twitter') ? 'has-error' : '' }}"  value="{{ old('twitter', isset($social) ? $social->twitter : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="youtube" name="youtube" class="form-control {{ $errors->has('youtube') ? 'has-error' : '' }}"  value="{{ old('youtube', isset($social) ? $social->youtube : '') }}">
...
{{--                            <textarea id="description" name="description" class="ckeditor  {{ $errors->has('description') ? 'has-error' : '' }}" >value="{{ old('description', isset($about) ? $about->description : '') }}"</textarea>--}}
