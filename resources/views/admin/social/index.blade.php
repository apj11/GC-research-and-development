...
@section('content')
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">All Social</li>
                </ol>
            </nav>
    ...
    <div class="content-body content-body-calendar" style="margin-top: -50px;">
        <div class="d-md-flex justify-content-between">
            <h4 class="content-title mg-t-10">Welcome to social</h4>
            <a href="{{route('social.create')}}" class="btn btn-sm btn-primary"> Add new Social</a>
                ...
                @foreach($social as $key =>$social  )
                    <tr id="social{{$social->id}}">
                        ...
                        <td class="d-md-flex">
                            ...
                            <div class="mg-r-20" title="Edit"><a href="{{route('social.edit',$social->id)}}"><i class="far fa-edit text-warning"></i></a></div>
                            ...
                            <a href="javascript:void(0)" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger remove_button" url="{{route('social.destroy',$social->id)}}"><i class="fa fa-times"></i></a>
                        </td>
                    </tr>
                    {{--                <tr>--}}
                    {{--                    <td>2076/12/15</td>--}}
