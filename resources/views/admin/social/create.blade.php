                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="block">
                            ...
                            <form action="{{route('social.store')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
...
{{--                                </div>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="twitter" name="twitter" class="form-control {{ $errors->has('twitter') ? 'has-error' : '' }}" placeholder="Enter link..">
...
{{--                                </div>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="instagram" name="instagram" class="form-control {{ $errors->has('instagram') ? 'has-error' : '' }}" placeholder="Enter link..">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="youtube" name="youtube" class="form-control {{ $errors->has('youtube') ? 'has-error' : '' }}" placeholder="Enter link..">
