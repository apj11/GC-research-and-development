    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="block">
                ...
                <form action="{{route('partner.store')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                    ...
                    {{--                                </div>--}}
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="product-name">Partners Name</label>
                        <div class="col-md-9">
