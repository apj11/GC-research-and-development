...
@section('content')
    ...
    <div class="content-body content-body-calendar" style="margin-top: -50px;">
        <div class="d-md-flex justify-content-between">
            <h4 class="content-title mg-t-10">Welcome to event</h4>
            <a href="{{route('event.create')}}" class="btn btn-sm btn-primary"> Add new event</a>
                ...
                @foreach($event as $key =>$event )
                    <tr id="event{{$event->id}}">
                        ...
                        <td class="d-md-flex">
                            ...
                            <div class="mg-r-20" title="Edit"><a href="{{route('event.edit',$event->id)}}"><i class="far fa-edit text-warning"></i></a></div>
                            <div class="mg-r-20" title="Delete"><a href="{{route('event.destroy',$event->id)}}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="icon ion-trash-b text-danger"></i></a></div>
{{--                            <a href="javascript:void(0)" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger remove_button" url="{{route('event.destroy',$event->id)}}"><i class="fa fa-times"></i></a>--}}
                        </td>
                    </tr>
                    {{--                <tr>--}}
                    {{--                    <td>2076/12/15</td>--}}
