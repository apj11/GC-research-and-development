    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="block">
                ...
                <form action="{{route('service.update',[$service->id])}}" method="post" class="form-horizontal form-bordered"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="title" name="title" class="form-control {{ $errors->has('title') ? 'has-error' : '' }}"  value="{{ old('title', isset($service) ? $service->title : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="file" id="image" name="image" class="form-control {{ $errors->has('image') ? 'has-error' : '' }}"  value="{{ old('image', isset($service) ? $service->image : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <textarea id="description" name="description" class="ckeditor  {{ $errors->has('description') ? 'has-error' : '' }}" >{!! old('description', isset($service) ? $service->description : '') !!} </textarea>
