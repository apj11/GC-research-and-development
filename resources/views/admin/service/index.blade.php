...
@section('content')
    ...
    <div class="content-body content-body-calendar" style="margin-top: -50px;">
        <div class="d-md-flex justify-content-between">
            <h4 class="content-title mg-t-10">Welcome to service</h4>
            <a href="{{route('service.create')}}" class="btn btn-sm btn-primary"> Add new Service</a>
            ...
            <table id="example1" class="table">
                ...
                @foreach($service as $key =>$service  )
                    <tr id="service{{$service->id}}">
                        ...
                        <td ><img src="{{asset(''.$service->image)}}" height="100px" width="100px"></td>
                        ...
                        <td class="d-md-flex">
                            ...
                            <div class="mg-r-20" title="Edit"><a href="{{route('service.edit',$service->id)}}"><i class="far fa-edit text-warning"></i></a></div>
                            ...
                            <a href="javascript:void(0)" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger remove_button" url="{{route('service.destroy',$service->id)}}"><i class="fa fa-times"></i></a>
                        </td>
                    </tr>
                    {{--                <tr>--}}
                    {{--                    <td>2076/12/15</td>--}}
