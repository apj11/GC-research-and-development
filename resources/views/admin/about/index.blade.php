...
{{--<link href="{{asset('css/plugins/switchery/switchery.css')}}" rel="stylesheet">--}}
    ...
    <div class="content-body content-body-calendar" style="margin-top: -50px;">
        <div class="d-md-flex justify-content-between">
            <h4 class="content-title mg-t-10">Welcome to about</h4>
            <a href="{{route('about.create')}}" class="btn btn-sm btn-primary"> Add new About</a>
...
{{--                   <div class="mg-r-20" title="View"><a href="{{route('customer.show',$customer->id)}}"><i class="icon ion-clipboard text-success"></i></a></div>--}}
                        <div class="mg-r-20" title="Edit"><a href="{{route('about.edit',$about->id)}}"><i class="far fa-edit text-warning"></i></a></div>
