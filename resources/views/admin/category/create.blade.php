    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="block">
                ...
                <form action="{{route('category.store')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
...
{{--                    <div class="form-group">--}}
{{--                        <label class="col-md-3 control-label" for="product-description">History</label>--}}
{{--                        <div class="col-md-9">--}}
{{--                            <!-- CKEditor, you just need to include the plugin (see at the bottom of this page) and add the class 'ckeditor' to your textarea -->--}}
{{--                            <!-- More info can be found at http://ckeditor.com -->--}}
{{--                            <textarea id="history" name="history" class="ckeditor  {{ $errors->has('history') ? 'has-error' : '' }}"></textarea>--}}
