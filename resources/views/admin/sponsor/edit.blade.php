        ...
        <div class="col-lg-12">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Update</strong> Sponsor</h2>
                </div>
                <!-- END General Data Title -->

                <!-- General Data Content -->
                <form action="{{route('sponsor.update',[$sponsor->id])}}" method="post" class="form-horizontal form-bordered"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="title" name="title" class="form-control {{ $errors->has('title') ? 'has-error' : '' }}"  value="{{ old('title', isset($sponsor) ? $sponsor->title : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="file" id="image" name="image" class="form-control {{ $errors->has('image') ? 'has-error' : '' }}"  value="{{ old('image', isset($sponsor) ? $sponsor->image : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <textarea id="description" name="description" class="ckeditor  {{ $errors->has('description') ? 'has-error' : '' }}" >{!! old('description', isset($sponsor) ? $sponsor->description : '')  !!}</textarea>
