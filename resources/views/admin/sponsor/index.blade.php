...
@section('content')
    ...
    <div class="content-header">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Sponsor or partners</a></li>
                    <li class="breadcrumb-item active" aria-current="page">All Sponsor or partners</li>
                </ol>
            </nav>
    ...
    <div class="content-body content-body-calendar" style="margin-top: -50px;">
        <div class="d-md-flex justify-content-between">
            <h4 class="content-title mg-t-10">Welcome to Sponsor or partners</h4>
            <a href="{{route('sponsor.create')}}" class="btn btn-sm btn-primary"> Add new Sponsor or partners</a>
            ...
            <table id="example1" class="table">
                ...
                @foreach($sponsor as $key =>$sponsor )
                    <tr id="sponsor{{$sponsor->id}}">
                        ...
                        <td ><img src="{{asset(''.$sponsor->image)}}" height="100px" width="100px"></td>
                        {{--                        <td >{{$blog->author}} </td>--}}
                        {{--                        <td >{!! $blog->category !!} </td>--}}
                        ...
                        <td class="d-md-flex">
                            ...
                            <div class="mg-r-20" title="Edit"><a href="{{route('sponsor.edit',$sponsor->id)}}"><i class="far fa-edit text-warning"></i></a></div>
                            ...
                            <a href="javascript:void(0)" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger remove_button" url="{{route('sponsor.destroy',$sponsor->id)}}"><i class="fa fa-times"></i></a>
                        </td>
                    </tr>
                    {{--                <tr>--}}
                    {{--                    <td>2076/12/15</td>--}}
