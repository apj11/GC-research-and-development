        ...
        <div class="col-lg-12">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Update</strong> productdetail</h2>
                </div>
                <!-- END General Data Title -->

                <!-- General Data Content -->
                <form action="{{route('productdetail.update',[$productdetail->id])}}" method="post" class="form-horizontal form-bordered"  enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="title" name="title" class="form-control {{ $errors->has('title') ? 'has-error' : '' }}"  value="{{ old('title', isset($productdetail) ? $productdetail->title : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="file" id="image" name="image" class="form-control {{ $errors->has('image') ? 'has-error' : '' }}"  value="{{ old('image', isset($productdetail) ? $productdetail->image : '') }}">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="product-name">Product Category</label>
                        <div class="col-md-9">
                            <input type="text" id="category" name="category" class="form-control {{ $errors->has('category') ? 'has-error' : '' }}"  value="{{ old('category', isset($productdetail) ? $productdetail->category : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <textarea id="description" name="description" class="ckeditor  {{ $errors->has('description') ? 'has-error' : '' }}" >{!! old('description', isset($productdetail) ? $productdetail->description : '') !!} </textarea>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="product-name"> Product Tags</label>
                        <div class="col-md-9">
                            <input type="text" id="tags" name="tags" class="form-control {{ $errors->has('tags') ? 'has-error' : '' }}"  value="{{ old('tags', isset($productdetail) ? $productdetail->tags : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="facebook" name="facebook" class="form-control {{ $errors->has('facebook') ? 'has-error' : '' }}"  value="{{ old('facebook', isset($productdetail) ? $productdetail->facebook : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="instagram" name="instagram" class="form-control {{ $errors->has('instagram') ? 'has-error' : '' }}"  value="{{ old('instagram', isset($productdetail) ? $productdetail->instagram : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="twitter" name="twitter" class="form-control {{ $errors->has('twitter') ? 'has-error' : '' }}"  value="{{ old('twitter', isset($productdetail) ? $productdetail->twitter : '') }}">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="product-name">Youtube</label>
                        <div class="col-md-9">
                            <input type="text" id="youtube" name="youtube" class="form-control {{ $errors->has('youtube') ? 'has-error' : '' }}"  value="{{ old('youtube', isset($productdetail) ? $productdetail->youtube : '') }}">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="product-name">Google</label>
                        <div class="col-md-9">
                            <input type="text" id="google" name="google" class="form-control {{ $errors->has('google') ? 'has-error' : '' }}"  value="{{ old('google', isset($productdetail) ? $productdetail->google : '') }}">
...
{{--                        <div class="col-md-9">--}}
{{--                            <input type="text" id="author" name="author" class="form-control {{ $errors->has('author') ? 'has-error' : '' }}"  value="{{ old('author', isset($productdetail) ? $productdetail->author : '') }}">--}}
