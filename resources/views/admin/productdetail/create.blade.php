                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="block">
                            ...
                            <div class="block-title">
                                <h2><i class="fa fa-pencil"></i> <strong>Create</strong> Product details</h2>
                            </div>
                            <!-- END General Data Title -->

                            <!-- General Data Content -->
                            <form action="{{route('productdetail.store')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
...
{{--                                </div>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="category" name="category" class="form-control {{ $errors->has('category') ? 'has-error' : '' }}" placeholder="Enter category..">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="product-description">Product description</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="product-name">Tags</label>
                                    <div class="col-md-9">
                                        <input type="text" id="tags" name="tags" class="form-control {{ $errors->has('tags') ? 'has-error' : '' }}" placeholder="Enter tags..">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="facebook" name="facebook" class="form-control {{ $errors->has('facebook') ? 'has-error' : '' }}" placeholder="Enter facebook link..">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="instagram" name="instagram" class="form-control {{ $errors->has('instagram') ? 'has-error' : '' }}" placeholder="Enter instagram link..">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="twitter" name="twitter" class="form-control {{ $errors->has('twitter') ? 'has-error' : '' }}" placeholder="Enter twitter link..">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="youtube" name="youtube" class="form-control {{ $errors->has('youtube') ? 'has-error' : '' }}" placeholder="Enter youtube link..">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="google" name="google" class="form-control {{ $errors->has('google') ? 'has-error' : '' }}" placeholder="Enter google link..">
