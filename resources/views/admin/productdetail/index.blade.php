...
@section('content')
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">All Product Details</li>
                </ol>
            </nav>
    ...
    <div class="content-body content-body-calendar" style="margin-top: -50px;">
        <div class="d-md-flex justify-content-between">
            <h4 class="content-title mg-t-10">Welcome to productdetail</h4>
            <a href="{{route('productdetail.create')}}" class="btn btn-sm btn-primary"> Add new productdetail</a>
        ...
        <div class="component-section">
            ...
            <table id="example1" class="table">
                ...
                @foreach($productdetail as $key =>$productdetail )
                    <tr id="productdetail{{$productdetail->id}}">
                        <td class="text-center">{{++$key}}</td>
                        <td>{!! $productdetail->title !!} </td>
                        <td><img src="{{asset(''.$productdetail->image)}}" height="100px" width="100px"></td>
                        <td>{!! $productdetail->category !!} </td>
                        <td>{{$productdetail->description}}</td>
                        <td>{!! $productdetail->tags !!} </td>
                        <td>{!! $productdetail->facebook!!}</td>
                        <td>{!! $productdetail->instagram !!} </td>
                        <td>{!! $productdetail->twitter !!} </td>
                        <td>{!! $productdetail->youtube!!}</td>
                        <td>{!! $productdetail->google !!} </td>
                        ...
                        <td class="d-md-flex">
                            ...
                            <div class="mg-r-20" title="Edit"><a href="{{route('productdetail.edit',$productdetail->id)}}"><i class="far fa-edit text-warning"></i></a></div>
                                 <div class="mg-r-20" title="Delete"><a href="{{route('productdetail.destroy',$productdetail->id)}}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="icon ion-trash-b text-danger"></i></a></div>
                            <!-- <a href="javascript:void(0)" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger remove_button" url="{{route('productdetail.destroy',$productdetail->id)}}"><i class="fa fa-times"></i></a> -->
                        </td>
                    </tr>
                    {{--                <tr>--}}
                    {{--                    <td>2076/12/15</td>--}}
