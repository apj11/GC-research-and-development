        ...
        <div class="col-lg-12">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Update</strong> Notice</h2>
                </div>
                <!-- END General Data Title -->

                <!-- General Data Content -->
                <form action="{{route('notice.update',[$notice->id])}}" method="post" class="form-horizontal form-bordered"  enctype="multipart/form-data">
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="title" name="title" class="form-control {{ $errors->has('title') ? 'has-error' : '' }}"  value="{{ old('title', isset($notice) ? $notice->title : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="date" id="date" name="date" class="form-control {{ $errors->has('date') ? 'has-error' : '' }}"  value="{{ old('date', isset($notice) ? $notice->date : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <textarea id="description" name="description" class="ckeditor  {{ $errors->has('description') ? 'has-error' : '' }}" >{!! old('description', isset($notice) ? $notice->description : '') !!} </textarea>
...
{{--                        <div class="col-md-9">--}}
{{--                            <input type="text" id="author" name="author" class="form-control {{ $errors->has('author') ? 'has-error' : '' }}"  value="{{ old('author', isset($notice) ? $notice->author : '') }}">--}}
...
{{--                        <div class="col-md-9">--}}
{{--                            <input type="text" id="category" name="category" class="form-control {{ $errors->has('category') ? 'has-error' : '' }}"  value="{{ old('category', isset($notice) ? $notice->category : '') }}">--}}
