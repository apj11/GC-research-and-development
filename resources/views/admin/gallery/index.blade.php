                ...
                @foreach($gallery as $key =>$gallery )
                    <tr id="gallery{{$gallery->id}}">
                        ...
                        <td class="d-md-flex">
                            ...
                            <div class="mg-r-20" title="Edit"><a href="{{route('gallery.edit',$gallery->id)}}"><i class="far fa-edit text-warning"></i></a></div>
                           <div class="mg-r-20" title="Delete"><a href="{{route('gallery.destroy',$gallery->id)}}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="icon ion-trash-b text-danger"></i></a></div>
