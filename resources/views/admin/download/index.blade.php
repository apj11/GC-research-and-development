...
@section('content')
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">All download</li>
                </ol>
            </nav>
    ...
    <div class="content-body content-body-calendar" style="margin-top: -50px;">
        <div class="d-md-flex justify-content-between">
            <h4 class="content-title mg-t-10">Welcome to download</h4>
            <a href="{{route('download.create')}}" class="btn btn-sm btn-primary"> Add new download</a>
