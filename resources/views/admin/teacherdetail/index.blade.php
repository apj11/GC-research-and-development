...
@section('content')
    ...
    {{--        <div>--}}
    {{--            <a href="../index.blade.php" class="sidebar-logo"><span>cassie</span></a>--}}
    ...
    <div class="content-header">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">teacherdetail</a></li>
                    <li class="breadcrumb-item active" aria-current="page">All teacherdetail</li>
                </ol>
            </nav>
    ...
    <div class="content-body content-body-calendar" style="margin-top: -50px;">
        <div class="d-md-flex justify-content-between">
            <h4 class="content-title mg-t-10">Welcome to teacherdetail</h4>
            <a href="{{route('teacherdetail.create')}}" class="btn btn-sm btn-primary"> Add new teacherdetail</a>
        ...
        <div class="component-section">
            ...
            <table id="example1" class="table">
                ...
                <tbody>
                @foreach($teacherdetail as $key =>$teacherdetail )
                    <tr id="teacherdetail{{$teacherdetail->id}}">
                        <td class="text-center">{{++$key}}</td>
                        <td>{!! $teacherdetail->name !!} </td>
                        <td><img src="{{asset(''.$teacherdetail->image)}}" height="100px" width="100px"></td>
                        <td>{!! $teacherdetail->profession !!} </td>
                        <td>{{$teacherdetail->description}}</td>
                        <td>{!! $teacherdetail->degree !!} </td>
                        <td>{!! $teacherdetail->experience!!}</td>
                        <td>{!! $teacherdetail->faculty !!} </td>
                        <td>{!! $teacherdetail->email!!}</td>
                        <td>{!! $teacherdetail->phone !!} </td>
                        <td>{!! $teacherdetail->facebook!!}</td>
                        <td>{!! $teacherdetail->instagram !!} </td>
                        <td>{!! $teacherdetail->twitter !!} </td>


                        <td >{{$teacherdetail->date}} </td>
                        {{--                        <td >{{$teacherdetail->author}} </td>--}}
                        {{--                        <td >{!! $teacherdetail->category !!} </td>--}}
                        ...
                        <td class="d-md-flex">
                            ...
                            <div class="mg-r-20" title="Edit"><a href="{{route('teacherdetail.edit',$teacherdetail->id)}}"><i class="far fa-edit text-warning"></i></a></div>
                                 <div class="mg-r-20" title="Delete"><a href="{{route('teacherdetail.destroy',$teacherdetail->id)}}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="icon ion-trash-b text-danger"></i></a></div>
                            <!-- <a href="javascript:void(0)" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger remove_button" url="{{route('teacherdetail.destroy',$teacherdetail->id)}}"><i class="fa fa-times"></i></a> -->
                        </td>
                    </tr>
                    {{--                <tr>--}}
                    {{--                    <td>2076/12/15</td>--}}
