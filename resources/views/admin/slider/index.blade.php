...
@section('content')
    ...
    <div class="content-body content-body-calendar" style="margin-top: -50px;">
        <div class="d-md-flex justify-content-between">
            <h4 class="content-title mg-t-10">Welcome to Slider</h4>
            ...
            <table id="example1" class="table">
                ...
                @foreach($slider as $key =>$slider )
                    <tr id="slider{{$slider->id}}">
                        ...
                        {{--                            <td >{{$about->service_title}} </td>--}}
                        {{--                            <td >{{$about->service_image}} </td>--}}
                        {{--                            <td >{!! $about->service_description !!}} </td>--}}
                        {{--                            <td >{!! $about->team_description !!}} </td>--}}
                        {{--                            <td >{{$about->team_image}} </td>--}}

                        <td class="text-center">
                            <div class="btn-group btn-group-xs">
{{--                                <a href="{{route('slider.edit',$slider->id)}}" data-toggle="tooltip" title="Edit" class="btn btn-default"><i class="fa fa-pencil"></i></a>--}}
                                <div class="mg-r-20" title="Edit"><a href="{{route('slider.edit',$slider->id)}}"><i class="far fa-edit text-warning"></i></a></div>
{{--                                <a href="{{route('slider.destroy',$slider->id)}}" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-times"></i></a>--}}
                                <a href="javascript:void(0)" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger remove_button" url="{{route('slider.destroy',$slider->id)}}"><i class="fa fa-times"></i></a>
                            </div>
                        </td>
