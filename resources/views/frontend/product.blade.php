...
<figure class="iz iz-js-image-zoom" data-large-size="700x300">
  <img class="iz__thumb iz-js-thumb" src="images/slider1.png" alt="[[fill me!]]" touch-action="none" width="200" height="400">
  ...
  <div class="col-md-6">
    <div class="rating_blk">
                ...
                <div class="category">
                  <ul>
                    <li>Category: <span>Mechine Tools Accessories</span></li>
                    <li>Tags: <span>Auto, Car</span></li>
                    <li>Share: <span><i class="fab fa-facebook-f" aria-hidden="true"></i> <i class="fab fa-twitter" aria-hidden="true"></i> <i class="fab fa-instagram" aria-hidden="true"></i> <i class="fab fa-youtube" aria-hidden="true"></i> <i class="fab fa-google-plus-g" aria-hidden="true"></i></span></li>
                  </ul>
                </div><!-- category -->
                <hr>
